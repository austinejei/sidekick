...
{
    public class SidekickAuthenticationHandler : AuthenticationHandler<SidekickAuthenticationOptions>
    {
        ...
        public SidekickAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new SidekickReturnEndpointContext(Context, ticket)
                              {
